...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="half address">
		...
		<a href="<?php echo esc_url( add_query_arg('address', $name, get_permalink(woocommerce_get_page_id( 'edit_address' ) ) ) ); ?>" class="edit button"><?php _e( 'EDIT ADDRESS', 'woocommerce' ); ?></a>
	</div>
